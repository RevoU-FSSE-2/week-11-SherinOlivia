...
productrouter.post('/new',authenMiddleware, authorMiddleware(['staff','admin']), productsController.createNewProduct);

// Update Product Qty / Price ===> Staff & Admin Only!
productrouter.patch('/update/:name',authenMiddleware, authorMiddleware(['staff','admin']), productsController.updateProduct);
